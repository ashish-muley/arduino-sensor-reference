...
Open [`Examples/Blink_LED.ino`](Examples/Blink_LED.ino) and upload it. The onboard LED next to pin 13 should blink on/off every second. No external wiring needed — this only tests the onboard LED.
