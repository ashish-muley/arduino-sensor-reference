...
Open [`01-blink-led/blink_led.ino`](01-blink-led/blink_led.ino) and upload it. The onboard LED next to pin 13 should blink on/off every second. No external wiring needed.
