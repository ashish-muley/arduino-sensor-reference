...
Open [`01-blink-led/blink_led.ino`](01-blink-led/blink_led.ino) and upload it. If nothing blinks, confirm your board's actual LED pin (see table above) and update the `LED_PIN` value in the sketch.
